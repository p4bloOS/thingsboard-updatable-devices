...
class Utf8BytesBLEUplinkConverter(BLEUplinkConverter):
                        ...
                        for exp in expression_arr:
                            ...
                            if len(indexes) == 2:
                                ...
                                for sub_item in concat_arr:
                                    char_bytes.append(sub_item)
                            else:
                                char_bytes.append(item['data'][int(indexes[0])])

                            data_to_replace = char_bytes.decode('utf-8')
